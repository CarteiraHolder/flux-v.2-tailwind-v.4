    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-4 max-lg:hidden">
            <div class="text-white relative rounded-lg h-full w-full bg-zinc-900 flex flex-col items-start justify-end p-16"
                style="background-image: url('https://images.unsplash.com/photo-1587620962725-abab7fe55159?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cHJvZ3JhbWElQzMlQTclQzMlQTNvfGVufDB8fDB8fHww'); background-size: cover">
                ...
                <div class="flex gap-4">
                    <flux:avatar src="/img/demo/caleb.png" class="size-12" />
